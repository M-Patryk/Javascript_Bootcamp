...
//REFACTORED CODE - Info how things work below!

const makeChart = (games, targetTeam) => {
	const parentUl = document.createElement('ul');
	for (let game of games) {
		const gameLi = document.createElement('li');
		gameLi.innerHTML = getInfo(game);
		gameLi.classList.add(checkForWinner(game, targetTeam) ? 'win' : 'loss');
		parentUl.append(gameLi);
	}
	return parentUl;
};
//Function priting info
